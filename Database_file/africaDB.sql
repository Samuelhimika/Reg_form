...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2023 at 07:22 PM
...
-- Database: `africareg`
--
CREATE DATABASE IF NOT EXISTS `africareg` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `africareg`;
...
CREATE TABLE `members` (
  ...
  `email` varchar(10) NOT NULL DEFAULT '@gmail.com',
...
INSERT INTO `members` (`fname`, `lname`, `nationality`, `academy`, `email`, `country`) VALUES
('Samuel', 'Hiimika', 'Uganda', 'ACUP', 'himikasa45', 'Uganda'),
('Samuel', 'Hiimika', 'Uganda', 'ACUP', 'himikasa45', 'Uganda');
--
-- Database: `onlinefoodphp`
--
CREATE DATABASE IF NOT EXISTS `onlinefoodphp` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `onlinefoodphp`;
...
(1, 'farmer', '@farmer2000', 'farmer@gmail.com', '', '2023-11-18 12:22:09');
...
(7, 'Sam Hiimika', 'Jr', 'Agaba', 'himikasa45@gmail.com', '+256 789 288 985', '63157ec36ea28fc3c65ddcd4067e6b11', 'Kisoro', 1, '2023-11-18 12:12:00');
...
(10, 7, 'Yorkshire Lamb Patties', 2, '14.00', NULL, '2023-11-18 12:13:04');
...
('root', '[{\"db\":\"africareg\",\"table\":\"members\"},{\"db\":\"africareg\",\"table\":\"Members\"},{\"db\":\"AfricaReg\",\"table\":\"Members\"},{\"db\":\"onlinefoodphp\",\"table\":\"admin\"},{\"db\":\"onlinefoodphp\",\"table\":\"dishes\"},{\"db\":\"onlinefoodphp\",\"table\":\"users\"}]');
...
('root', 'africareg', 'members', '{\"CREATE_TIME\":\"2023-11-20 16:00:52\"}', '2023-11-20 18:10:58');
...
('root', '2023-11-20 18:21:33', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
